[org 0x7c00]	; this is important because the boot sector code originates 		    ; from this address. Therefore if this is not specified
...
buffer db "Shayak is awesome",0x00	; it is important to define addition					    ; al bytes later on because the bios
